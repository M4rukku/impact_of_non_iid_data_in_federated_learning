...
For centralised evaluation and baseline (IID) convergence models, we utilise IID datasets. These
 ...
 Please execute this script with at least the following arguments:
 ```
python create_iid_datasets.py --femmnist_full --celeba_full --shakespeare_full 
python create_iid_datasets.py --celeba --femnist --shakespeare
```
