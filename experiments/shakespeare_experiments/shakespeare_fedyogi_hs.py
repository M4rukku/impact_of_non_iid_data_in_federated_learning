...
def shakespeare_fedyogi_hs():
    ...
    variation_map = {
        "client_learning_rate": [e(-2.0), e(-1), e(0)],
        "server_learning_rate": [e(-3.0), e(-2.0), e(-1.0), e(0.0)]
    }

    tau = e(-3)

    def provides_strategy_provider_for_fed_yogi(d: Dict[str, float]) -> \
    ...
    pgmg = ParameterGridMetadataGenerator(variation_map,
                                          provides_strategy_provider_for_fed_yogi,
