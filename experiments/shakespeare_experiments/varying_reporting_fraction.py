...
from experiments.shakespeare_experiments.shakespeare_metadata_providers import \
    SHAKESPEARE_BASE_METADATA_SYS_EXP_PROVIDER, VARYING_REPORTING_FRACTION_EXP_PARAMETER_MAP
...
def shakespeare_vrf():
    ...
    pgmg = ParameterGridMetadataGenerator(
        {"clients_per_round": VARYING_REPORTING_FRACTION_EXP_PARAMETER_MAP},
    ...
    SimulateExperiment.start_experiment(
        f"Shakespeare_Varying_Cohort_Size",
        model_template,
        dataset_factory,
