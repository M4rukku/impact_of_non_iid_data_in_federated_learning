...
from experiments.celeba_experiments.celeba_metadata_providers import \
    CELEBA_BASE_METADATA_SYS_EXP_PROVIDER, VARYING_REPORTING_FRACTION_EXP_PARAMETER_MAP
...
def celeba_vrf():
    ...
    pgmg = ParameterGridMetadataGenerator(VARYING_REPORTING_FRACTION_EXP_PARAMETER_MAP,
                                          ...
                                          lambda d: model_template.get_optimizer(0.02),
    ...
    SimulateExperiment.start_experiment(
        f"Celeba_Varying_Clients_Per_Round",
        model_template,
        dataset_factory,
