...
class ShakespeareClientDatasetFactory(FileSystemBasedClientDatasetFactory):

    def __init__(self, root_data_dir: Path, path_from_data_dir_to_client_dataset="shakespeare"):
    ...
    def create_dataset(self, client_identifier: str, alphabet: str = LEAF_CHARACTERS):
        ...
        client_dataset_processor = ShakespeareClientDatasetProcessor(alphabet=alphabet)
